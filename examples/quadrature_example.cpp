...
int main(int argc, char* argv[])
{
    ...
    for (; domIt->good(); domIt->next() )
    {
        ...
        GaussRule.conservativeResize(NoChange,GaussRule.cols()+points.cols());
        ...
        MixedRule.conservativeResize(NoChange,MixedRule.cols()+points.cols());
        ...
        TensorPatch.conservativeResize(NoChange,TensorPatch.cols()+points.cols());
