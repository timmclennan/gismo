...
void pybind11_init_gsGeometry(py::module &m)
{
  ...
  .def("basis", static_cast<const gsBasis<real_t>& (Class::*)() const>(&Class::basis), "Returns the bspline basis", py::return_value_policy::reference_internal)
  .def("basis", static_cast<gsBasis<real_t>& (Class::*)()>(&Class::basis), "Returns the bspline basis as a reference", py::return_value_policy::reference_internal)
