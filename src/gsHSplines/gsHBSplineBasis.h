...
private:
   ...
   */
 GISMO_EXPORT void pybind11_init_gsHBSplineBasis2(pybind11::module &m);
 GISMO_EXPORT void pybind11_init_gsHBSplineBasis3(pybind11::module &m);
 GISMO_EXPORT void pybind11_init_gsHBSplineBasis4(pybind11::module &m);
